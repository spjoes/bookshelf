...
namespace NzbDrone.Core.Notifications.CustomScript
{
    public class CustomScript : NotificationBase<CustomScriptSettings>
    {
        ...
        public override void OnGrab(GrabMessage message)
        {
            ...
            environmentVariables.Add("Readarr_Release_GRIds", remoteBook.Books.Select(x => x.Editions.Value.First(e => e.Monitored).ForeignEditionId).ConcatToString("|"));
        ...
        public override void OnReleaseImport(BookDownloadMessage message)
        {
            ...
            environmentVariables.Add("Readarr_Book_GRId", book.Editions.Value.First(e => e.Monitored).ForeignEditionId.ToString());
